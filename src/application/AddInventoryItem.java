...
public class AddInventoryItem {
	...
	public AddInventoryItem(){
		invH.getChildren().addAll(invL,baN);
	...
	public TextField getBaN() {
		return baN;
	}

	public void setBaN(TextField baN) {
		this.baN = baN;
	}
