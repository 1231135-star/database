...
public class DeleteBranch {
	private Label deleteBra=new Label("Delete Branch");
	...
	private Image deleteM=new Image("icons8-delete-all-100.png");
	...
	public DeleteBranch() {
		...
		all.getChildren().addAll(deleteBra,bIDH,bNH,midH,addH,pnH,eH,wsH,weH,hH,buttons);
		deleteBra.setStyle("-fx-text-fill: #0c343d; -fx-font-weight: bold;-fx-font-size:30px;");
		all.setAlignment(Pos.CENTER);
		all.setSpacing(20);
		all.setStyle("-fx-background-color: #a2c4c9;");
	}

	protected Label getDeleteBra() {
		return deleteBra;
	}

	protected void setDeleteBra(Label deleteBra) {
		this.deleteBra = deleteBra;
	}
