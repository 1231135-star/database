...
public class DeleteIP {
	private Label addIP=new Label("Delete Inssurance Ploicy");
	...
	private TextField issueDT=new TextField();
	private HBox issueDH=new HBox();

	private Label expiryD=new Label("Expiry Date :");
	private TextField expiryDT=new TextField();
	...
	private Button delete=new Button("Add",deleteVM);
	...
	public DeleteIP() {
		...
		issueDT.setEditable(false);
		issueDT.setVisible(true);
		...
		expiryDT.setEditable(false);
		expiryDT.setVisible(true);
	...
	protected TextField getIssueDT() {
		return issueDT;
	}

	protected void setIssueDT(TextField issueDT) {
	...
	protected TextField getExpiryDT() {
		return expiryDT;
	}

	protected void setExpiryDT(TextField expiryDT) {
