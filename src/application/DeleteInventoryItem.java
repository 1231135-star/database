...
public class DeleteInventoryItem {
		private Label addEmp=new Label("Delete Inventory Item");
		...
		private TextField expDT=new TextField();
		...
		public DeleteInventoryItem(){
			...
			expDT.setEditable(false);
			expDT.setVisible(true);
			...
			quanAvT.setEditable(false);
			quanAvT.setVisible(true);
			...
			purPT.setEditable(false);
			purPT.setVisible(true);
			...
			supT.setEditable(false);
			supT.setVisible(true);
		...
		public TextField getExpDT() {
			return expDT;
		}

		public void setExpDT(TextField expDT) {
			this.expDT = expDT;
		}
