...
public class DeletePayment {
	private Label addp=new Label("Delete Payment");
	...
	public DeletePayment() {
		...
		payIDT.setEditable(false);
		payIDT.setVisible(true);
		...
		payNT.setEditable(false);
		payNT.setVisible(true);
		...
		invIDT.setEditable(false);
		invIDT.setVisible(true);
		...
		refNT.setEditable(false);
		refNT.setVisible(true);
