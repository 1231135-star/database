...
public class DeletePurchase {
	private Label addIP=new Label("Delete Purchase");
	...
	private TextField pDaT=new TextField();
	...
	public DeletePurchase() {
		...
		braIDT.setEditable(false);
		braIDT.setVisible(true);
		...
		totCostT.setEditable(false);
		totCostT.setVisible(true);
		...
		payStatT.setEditable(false);
		payStatT.setVisible(true);
	...
	public TextField getpDaT() {
		return pDaT;
	}

	public void setpDaT(TextField pDaT) {
		this.pDaT = pDaT;
	}
