...
public class InvoiceQ19TableView {

    private Label mt = new Label("Q19 - Total Profit & Loss Per Branch");

    private TableView<InvoiceQ19Row> table = new TableView<>();
    private TableColumn<InvoiceQ19Row, Integer> colBID = new TableColumn<>("BranchID");
    private TableColumn<InvoiceQ19Row, String> colBName = new TableColumn<>("BranchName");
    private TableColumn<InvoiceQ19Row, Double> colSales = new TableColumn<>("TotalSales");
    private TableColumn<InvoiceQ19Row, Double> colProfit = new TableColumn<>("TotalProfit");
    private TableColumn<InvoiceQ19Row, Double> colLoss = new TableColumn<>("TotalLoss");
    ...
    public InvoiceQ19TableView() {
        ...
        colLoss.setCellValueFactory(new PropertyValueFactory<>("totalLoss"));

        table.getColumns().addAll(colBID, colBName, colSales, colProfit, colLoss);
    ...
    private ObservableList<InvoiceQ19Row> loadData() {
	...
	public TableView<InvoiceQ19Row> getTable() {
		return table;
	}

	public void setTable(TableView<InvoiceQ19Row> table) {
		this.table = table;
	}

	public TableColumn<InvoiceQ19Row, Integer> getColBID() {
		return colBID;
	}

	public void setColBID(TableColumn<InvoiceQ19Row, Integer> colBID) {
		this.colBID = colBID;
	}

	public TableColumn<InvoiceQ19Row, String> getColBName() {
		return colBName;
	}

	public void setColBName(TableColumn<InvoiceQ19Row, String> colBName) {
		this.colBName = colBName;
	}

	public TableColumn<InvoiceQ19Row, Double> getColSales() {
		return colSales;
	}

	public void setColSales(TableColumn<InvoiceQ19Row, Double> colSales) {
		this.colSales = colSales;
	}

	public TableColumn<InvoiceQ19Row, Double> getColProfit() {
		return colProfit;
	}

	public void setColProfit(TableColumn<InvoiceQ19Row, Double> colProfit) {
		this.colProfit = colProfit;
	}

	public TableColumn<InvoiceQ19Row, Double> getColLoss() {
		return colLoss;
	}

	public void setColLoss(TableColumn<InvoiceQ19Row, Double> colLoss) {
		this.colLoss = colLoss;
	}
