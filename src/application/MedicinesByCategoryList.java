...
public class MedicinesByCategoryList {
	...
	private Label title = new Label("Medicines Grouped by Category");

	private TableView<MedicineCategoryRow> table = new TableView<>();
	private ObservableList<MedicineCategoryRow> data = FXCollections.observableArrayList();

	private TableColumn<MedicineCategoryRow, String> colCategory = new TableColumn<>("Category");
	private TableColumn<MedicineCategoryRow, String> colMedId = new TableColumn<>("Medicine ID");
	private TableColumn<MedicineCategoryRow, String> colMedName = new TableColumn<>("Medicine Name");
	...
	public MedicinesByCategoryList() {
		...
		table.getColumns().addAll(colCategory, colMedId, colMedName);
		table.setItems(data);
	...
	public void addMedicine(String category, String medicineId, String medicineName) {
		data.add(new MedicineCategoryRow(category, medicineId, medicineName));
	}
	...
	public TableView<MedicineCategoryRow> getTable() {
		return table;
	}
}
