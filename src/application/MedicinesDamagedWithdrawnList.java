...
public class MedicinesDamagedWithdrawnList {
	...
	private Label title = new Label("Damaged & Withdrawn Medicines by Branch");

	private TableView<MedicineDamageRow> table = new TableView<>();
	private ObservableList<MedicineDamageRow> data = FXCollections.observableArrayList();

	private TableColumn<MedicineDamageRow, String> colBranch = new TableColumn<>("Branch");
	private TableColumn<MedicineDamageRow, String> colMedId = new TableColumn<>("Medicine ID");
	private TableColumn<MedicineDamageRow, String> colMedName = new TableColumn<>("Medicine Name");
	private TableColumn<MedicineDamageRow, String> colStatus = new TableColumn<>("Status");
	private TableColumn<MedicineDamageRow, String> colQuantity = new TableColumn<>("Quantity");
	...
	public MedicinesDamagedWithdrawnList() {
		...
		table.getColumns().addAll(colBranch, colMedId, colMedName, colStatus, colQuantity);
		table.setItems(data);
	...
	public void addMedicine(String branch, String medicineId, String medicineName, String status, String quantity) {
		data.add(new MedicineDamageRow(branch, medicineId, medicineName, status, quantity));
	}
	...
	public TableView<MedicineDamageRow> getTable() {
		return table;
	}
}
