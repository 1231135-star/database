...
public class MedicinesDetailsList {
    ...
    private TableColumn<MedicineDetailsRow, String> colId =
            new TableColumn<>("Medicine ID");
    private TableColumn<MedicineDetailsRow, String> colName =
            new TableColumn<>("Medicine Name");
    private TableColumn<MedicineDetailsRow, String> colCategory =
            new TableColumn<>("Category");
    private TableColumn<MedicineDetailsRow, String> colSupplier =
            new TableColumn<>("Supplier");
    private TableColumn<MedicineDetailsRow, String> colExpiry =
    ...
    public TableView<MedicineDetailsRow> getTable() { return table; }
}
