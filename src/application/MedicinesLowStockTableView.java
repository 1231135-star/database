...
public class MedicinesLowStockTableView {
    ...
    private Label mt =
            new Label("Out of Stock / Low Stock Medicines");

    private Label qtyL =
            new Label("Quantity ≤");
    private TextField qtyT =
            new TextField("5");
    ...
    private TableView<MedicineStockRow> table =
            new TableView<>();
    private ObservableList<MedicineStockRow> data =
            FXCollections.observableArrayList();

    private TableColumn<MedicineStockRow, String> colId =
            new TableColumn<>("Medicine ID");
    private TableColumn<MedicineStockRow, String> colName =
            new TableColumn<>("Medicine Name");
    private TableColumn<MedicineStockRow, String> colCategory =
            new TableColumn<>("Category");
    private TableColumn<MedicineStockRow, String> colSupplier =
            new TableColumn<>("Supplier");
    private TableColumn<MedicineStockRow, String> colQuantity =
    ...
    public MedicinesLowStockTableView() {
        ...
        table.getColumns().addAll(
                colId, colName, colCategory, colSupplier, colQuantity
        );
        table.setItems(data);
    ...
    public TableView<MedicineStockRow> getTable() { return table; }
}
