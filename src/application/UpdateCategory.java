...
public class UpdateCategory {
    ...
    private Label editCat = new Label("Edit Category");
    ...
    public UpdateCategory() {
        ...
        all.getChildren().addAll(editCat, searchH, catIDH, catNH, dH, buttons);
        editCat.setStyle("-fx-text-fill: #0c343d; -fx-font-weight: bold;-fx-font-size:30px;");
	...
	public Label getEditCat() {
		return editCat;
	}

	public void setEditCat(Label editCat) {
