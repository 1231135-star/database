...
public class UpdatePrescriptionMedicine {

    private Label title = new Label("Edit Prescription Medicine");
    ...
    public UpdatePrescriptionMedicine() {
        searchVM.setFitWidth(42); searchVM.setFitHeight(42);
        editVM.setFitWidth(42); editVM.setFitHeight(42);
